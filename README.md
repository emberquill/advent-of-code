...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `355.7µs` | `436.5µs` |
| [Day 2](./src/bin/02.rs) | `223.9µs` | `383.6µs` |
| [Day 3](./src/bin/03.rs) | `184.4µs` | `263.1µs` |
| [Day 4](./src/bin/04.rs) | `940.4µs` | `930.4µs` |
| [Day 5](./src/bin/05.rs) | `533.0µs` | `2.9ms` |
